...
public class RLUtils {
    private static final List<IResourceTransformer> transformers = new ArrayList<IResourceTransformer>();
    private static final ResourceLocation pixel = new ResourceLocation("mclib:textures/pixel.png");
